...
// Depends on: market @ 0x1755eaaebe4335fcf5f467dfaab73ba21047bdfbda1d97425e6a2cb961a055f4
const TEMPLATE_BYTECODES_B64 =
	"";
...
export async function buildPublishToken(params: CreateTokenParams): Promise<Transaction> {
	...
	const [upgradeCap] = tx.publish({
		...
		dependencies: [
			"0x1", // Move stdlib
			"0x2", // Sui framework
			"0x1755eaaebe4335fcf5f467dfaab73ba21047bdfbda1d97425e6a2cb961a055f4", // market
		],
	});
